...
export default class Employee extends Component {
    ...
    render() {
        ...
        <div id="form-container">
            <h3>Add Employee</h3>
            <form method="post"  name="employeeForm"  onSubmit={this.submitEmployeeRegForm} >
            ...
            <input type="submit" className="button btn-success"  value="Create"/>&nbsp;&nbsp;
